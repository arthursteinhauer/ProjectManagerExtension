...
/**
 * Test case for class \Ast\Projectmanager\Domain\Model\User.
 *
...
class UserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$this->subject = new \Ast\Projectmanager\Domain\Model\User();
	}
	 ...
	 * @test
	 */
	public function getHourlyRateReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getHourlyRate()
		);
	}
	 ...
	 * @test
	 */
	public function setHourlyRateForStringSetsHourlyRate()
	{
		$this->subject->setHourlyRate('Conceived at T3CON10');
