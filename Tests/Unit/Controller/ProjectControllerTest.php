...
/**
 * Test case for class Ast\Projectmanager\Controller\ProjectController.
 *
 */
class ProjectControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Ast\Projectmanager\Controller\ProjectController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Ast\\Projectmanager\\Controller\\ProjectController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProjectsFromRepositoryAndAssignsThemToView()
	{
		...
		$projectRepository = $this->getMock('Ast\\Projectmanager\\Domain\\Repository\\ProjectRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$project = new \Ast\Projectmanager\Domain\Model\Project();
	...
	public function createActionAddsTheGivenProjectToProjectRepository()
	{
		...
		$projectRepository = $this->getMock('Ast\\Projectmanager\\Domain\\Repository\\ProjectRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenProjectInProjectRepository()
	{
		...
		$projectRepository = $this->getMock('Ast\\Projectmanager\\Domain\\Repository\\ProjectRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenProjectFromProjectRepository()
	{
		...
		$projectRepository = $this->getMock('Ast\\Projectmanager\\Domain\\Repository\\ProjectRepository', array('remove'), array(), '', FALSE);
