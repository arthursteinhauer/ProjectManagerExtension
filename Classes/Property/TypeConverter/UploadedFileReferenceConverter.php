<?php
namespace Ast\Projectmanager\Property\TypeConverter;
/**
 *  Copyright notice
 *
...
class UploadedFileReferenceConverter extends AbstractTypeConverter {
	...
	protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration) {
		...
		$allowedFileExtensions = $configuration->getConfigurationValue('Ast\\Projectmanager\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
		...
		$uploadFolderId = $configuration->getConfigurationValue('Ast\\Projectmanager\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
		$conflictMode = $configuration->getConfigurationValue('Ast\\Projectmanager\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $this->defaultConflictMode;
	 ...
	 * @return \Ast\Projectmanager\Domain\Model\FileReference
	 */
	...
	protected function createFileReferenceFromFalFileReferenceObject(FalFileReference $falFileReference, $resourcePointer = NULL) {
		if ($resourcePointer === NULL) {
			/** @var $fileReference \Ast\Projectmanager\Domain\Model\FileReference */
